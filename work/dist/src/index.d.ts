...
export declare type HandleTotalTimeout<T> = (options: AttemptOptions<T>) => Promise<T>;
...
export declare function retry<T>(attemptFunc: AttemptFunction<T>, attemptOptions?: PartialAttemptOptions<T>): Promise<any>;
